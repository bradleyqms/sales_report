...
def _make_dispatch_reports_package() -> types.ModuleType:
    ...
    _stub("config",
          ...
          report_mtd_banner=lambda: "banner",
            dispatch_report_mode=lambda: os.getenv("V2_UNIFIED_REFRESH_REPORT_TYPE", "MTD").strip().upper() or "MTD",
            report_period_banner=lambda base_title, report_date=None, mode=None: f"{base_title} (period)",
            report_period_summary=lambda report_date=None, mode=None: "summary",
